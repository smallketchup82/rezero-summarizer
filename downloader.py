...
parser.add_argument("arcs", type=str, help="The arcs to download and process. Comma separated. Leave blank to process all available arcs.", default=None)
...
def handle_arc(arc: int):
    ...
    with open(os.path.join(directory, f"Arc {arc}.epub"), "w", encoding="utf-8") as file:
        file.write("\n\n".join(html))
